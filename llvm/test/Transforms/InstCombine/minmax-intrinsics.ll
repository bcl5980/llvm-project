...
; CHECK-NEXT:    [[TMP1:%.*]] = xor <3 x i8> [[Y:%.*]], <i8 0, i8 0, i8 undef>
; CHECK-NEXT:    [[TMP2:%.*]] = call <3 x i8> @llvm.smax.v3i8(<3 x i8> [[X:%.*]], <3 x i8> [[TMP1]])
; CHECK-NEXT:    [[M:%.*]] = xor <3 x i8> [[TMP2]], <i8 -1, i8 -1, i8 -1>
; CHECK-NEXT:    ret <3 x i8> [[M]]
;
