...
; CHECK-NEXT:    [[SEL_EQ:%.*]] = call i8 @llvm.scompare.i8.i32(i32 [[A:%.*]], i32 [[B:%.*]])
...
; CHECK-NEXT:    [[SEL_EQ:%.*]] = call i8 @llvm.ucompare.i8.i32(i32 [[A:%.*]], i32 [[B:%.*]])
; CHECK-NEXT:    ret i8 [[SEL_EQ]]
;
...
; CHECK-NEXT:    [[SEL_LT:%.*]] = call i8 @llvm.scompare.i8.i32(i32 [[A:%.*]], i32 [[B:%.*]])
...
; CHECK-NEXT:    [[SEL_GT:%.*]] = call i8 @llvm.scompare.i8.i32(i32 [[A:%.*]], i32 [[B:%.*]])
...
; CHECK-NEXT:    [[SEL_LT:%.*]] = call i8 @llvm.ucompare.i8.i32(i32 [[A:%.*]], i32 [[B:%.*]])
; CHECK-NEXT:    ret i8 [[SEL_LT]]
;
  %cmp.eq = icmp eq i32 %a, %b
  %sel.eq = select i1 %cmp.eq, i8 0, i8 1
...
; CHECK-NEXT:    [[SEL_GT:%.*]] = call i8 @llvm.ucompare.i8.i32(i32 [[A:%.*]], i32 [[B:%.*]])
; CHECK-NEXT:    ret i8 [[SEL_GT]]
;
  %cmp.eq = icmp eq i32 %a, %b
  %sel.eq = select i1 %cmp.eq, i8 0, i8 -1
...
; CHECK-NEXT:    [[SEL_LT:%.*]] = call <2 x i8> @llvm.ucompare.v2i8.v2i32(<2 x i32> [[A:%.*]], <2 x i32> [[B:%.*]])
...
; CHECK-NEXT:    [[SEL_GT:%.*]] = call <2 x i8> @llvm.ucompare.v2i8.v2i32(<2 x i32> [[A:%.*]], <2 x i32> [[B:%.*]])
