...
; CHECK-NEXT:    [[SEL1:%.*]] = tail call i64 @llvm.ucompare.i64.i32(i32 [[A]], i32 [[B]])
; CHECK-NEXT:    [[SEL1_OP:%.*]] = add nsw i64 [[SEL1]], 1
; CHECK-NEXT:    [[SWITCH_SELECTCMP1:%.*]] = icmp ult i64 [[SEL1_OP]], 2
