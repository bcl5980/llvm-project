...
; CHECKBE-NEXT:    and x8, x1, x8
; CHECKBE-NEXT:    and w0, w8, #0xffff
; CHECKBE-NEXT:    ret
...
; CHECK:       // %bb.0:
; CHECK-NEXT:    ldrh w8, [x0]
; CHECK-NEXT:    eor w0, w8, #0xffff
; CHECK-NEXT:    ret
;
; CHECKBE-LABEL: load32_and16_xorm1:
; CHECKBE:       // %bb.0:
; CHECKBE-NEXT:    ldrh w8, [x0, #2]
; CHECKBE-NEXT:    eor w0, w8, #0xffff
; CHECKBE-NEXT:    ret
  %x = load i32, i32* %p, align 4
  %xz = zext i32 %x to i64
  %a = xor i64 %xz, -1
...
; CHECK-NEXT:    and x8, x2, x8
; CHECK-NEXT:    and w0, w8, #0xffff
; CHECK-NEXT:    ret
;
; CHECKBE-LABEL: load64_and16:
; CHECKBE:       // %bb.0:
; CHECKBE-NEXT:    ldr x8, [x0]
; CHECKBE-NEXT:    and x8, x3, x8
; CHECKBE-NEXT:    and w0, w8, #0xffff
; CHECKBE-NEXT:    ret
