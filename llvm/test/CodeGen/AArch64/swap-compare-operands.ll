...
; CHECK-NEXT:    cmn x3, w8, uxtw #4
; CHECK-NEXT:    b.eq .LBB44_8
; CHECK-NEXT:  // %bb.2: // %t2
; CHECK-NEXT:    and w8, w2, #0xff
; CHECK-NEXT:    cmn x3, w8, uxtw #3
; CHECK-NEXT:    b.eq .LBB44_8
; CHECK-NEXT:  // %bb.3: // %t3
; CHECK-NEXT:    cmn w4, w1, uxth #2
; CHECK-NEXT:    b.eq .LBB44_8
; CHECK-NEXT:  // %bb.4: // %t4
; CHECK-NEXT:    cmn w4, w2, uxtb #1
; CHECK-NEXT:    b.eq .LBB44_8
; CHECK-NEXT:  // %bb.5: // %t5
; CHECK-NEXT:    and w8, w2, #0xff
; CHECK-NEXT:    cmn w4, w8, lsl #5
; CHECK-NEXT:    b.eq .LBB44_8
; CHECK-NEXT:  // %bb.6: // %t6
; CHECK-NEXT:    cmn w4, w2, uxtb
; CHECK-NEXT:    b.eq .LBB44_8
; CHECK-NEXT:  // %bb.7:
; CHECK-NEXT:    mov x0, xzr
; CHECK-NEXT:    ret
; CHECK-NEXT:  .LBB44_8: // %end
; CHECK-NEXT:    mov w0, #1
; CHECK-NEXT:    ret
t0:
...
; CHECK-NEXT:    b.eq .LBB45_8
; CHECK-NEXT:  // %bb.2: // %t2
; CHECK-NEXT:    cmn x3, w2, sxtb #3
; CHECK-NEXT:    b.eq .LBB45_8
; CHECK-NEXT:  // %bb.3: // %t3
; CHECK-NEXT:    cmn w4, w1, sxth #2
; CHECK-NEXT:    b.eq .LBB45_8
; CHECK-NEXT:  // %bb.4: // %t4
; CHECK-NEXT:    cmn w4, w2, sxtb #1
; CHECK-NEXT:    b.eq .LBB45_8
; CHECK-NEXT:  // %bb.5: // %t5
; CHECK-NEXT:    sxtb w8, w2
; CHECK-NEXT:    cmn w4, w8, lsl #5
; CHECK-NEXT:    b.eq .LBB45_8
; CHECK-NEXT:  // %bb.6: // %t6
; CHECK-NEXT:    cmn w4, w2, sxtb
; CHECK-NEXT:    b.eq .LBB45_8
; CHECK-NEXT:  // %bb.7:
; CHECK-NEXT:    mov x0, xzr
; CHECK-NEXT:    ret
; CHECK-NEXT:  .LBB45_8: // %end
; CHECK-NEXT:    mov w0, #1
; CHECK-NEXT:    ret
t0:
