...
; CHECK-OPT-NEXT:    .cfi_def_cfa_offset 64
...
; CHECK-FAST-NEXT:    .cfi_def_cfa_offset 64
...
; CHECK-OPT-LABEL: test_inttoptr:
; CHECK-OPT:       ; %bb.0:
; CHECK-OPT-NEXT:    mov w0, w0
; CHECK-OPT-NEXT:    ret
;
; CHECK-FAST-LABEL: test_inttoptr:
; CHECK-FAST:       ; %bb.0:
; CHECK-FAST-NEXT:    and x0, x0, #0xffffffff
; CHECK-FAST-NEXT:    ret
...
; CHECK-NEXT:    bl _get_int
; CHECK-NEXT:    mov w8, w0
; CHECK-NEXT:    orr x0, x8, x19, lsl #32
...
; CHECK-OPT-NEXT:    .cfi_def_cfa wsp, 0
; CHECK-OPT-NEXT:    .cfi_same_value w30
; CHECK-OPT-NEXT:    .cfi_same_value w29
; CHECK-OPT-NEXT:    ret
;
...
; CHECK-FAST-NEXT:    .cfi_def_cfa wsp, 0
; CHECK-FAST-NEXT:    .cfi_same_value w30
; CHECK-FAST-NEXT:    .cfi_same_value w29
; CHECK-FAST-NEXT:    ret
