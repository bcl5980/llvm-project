...
; GFX8-NEXT:    s_waitcnt vmcnt(1)
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v8, v6
...
; GFX8-NEXT:    s_waitcnt vmcnt(2)
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v10, v0
; GFX8-NEXT:    v_addc_u32_e32 v14, vcc, v11, v7, vcc
...
; GFX8-NEXT:    s_waitcnt vmcnt(3)
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v8, v0
; GFX8-NEXT:    v_addc_u32_e32 v14, vcc, v9, v14, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[8:9], v[4:5]
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, 0x10000, v4
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, 0, v5, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(3)
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v12, v0
; GFX8-NEXT:    v_addc_u32_e32 v12, vcc, v13, v14, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(2)
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v6, v0
; GFX8-NEXT:    v_addc_u32_e32 v6, vcc, v7, v12, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(1)
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v10, v0
; GFX8-NEXT:    v_addc_u32_e32 v7, vcc, v11, v6, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v8, v0
; GFX8-NEXT:    v_addc_u32_e32 v7, vcc, v9, v7, vcc
